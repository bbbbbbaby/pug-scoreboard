...
@keyframes pugfoodpop{0%{transform:translate(-50%,-140%) scale(.2);opacity:0}45%{transform:translate(-50%,-72%) scale(1.3);opacity:1}70%{transform:translate(-50%,-38%) scale(.9)}100%{transform:translate(-50%,-50%) scale(1);opacity:1}}
            ...
            <div className="pug-hero" style={{paddingTop:6}}>
              ...
              <div className="pug-roomzone">
                <div className="pug-room">
                  ...
                  {visConfig.creatura !== false && popKey>0 && <img key={popKey} src={FOODS[selectedFood]?.img} alt="" style={{position:"absolute",left:"49%",top:"56%",width:48,height:48,objectFit:"contain",filter:"drop-shadow(0 5px 3px rgba(0,0,0,.35))",animation:"pugfoodpop .6s ease-out",zIndex:4}}/>}
