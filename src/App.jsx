...
const css = `
  ...
  * { -webkit-tap-highlight-color: transparent; }
  ...
  .pd-name-pill { background:#111; color:#fff; font-family:'Funnel Display',sans-serif; font-size:21px; font-weight:900; text-transform:uppercase; letter-spacing:.07em; border-radius:10px 13px 10px 15px; padding:5px 18px; position:relative; z-index:3; margin-bottom:4px; box-shadow:2px 3px 0 rgba(0,0,0,.3); }
  ...
  return (
    <div className="login-wrap" style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px 16px",position:"relative"}}>
      ...
      <div style={{textAlign:"center",marginBottom:32}}>
        <div style={{fontFamily:"'Funnel Display',sans-serif",fontWeight:900,fontSize:"clamp(48px,12vw,80px)",lineHeight:.9,textTransform:"uppercase",letterSpacing:"-.02em",background:"linear-gradient(135deg,#00d4ff 0%,#fff 40%,#ff2d78 100%)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>
          PER·YOU<br/>GARDEN
        </div>
    ...
    <div>
      ...
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-end',marginBottom:7}}>
        <div style={{display:'flex',alignItems:'center',gap:7}}>
          ...
          <span style={{fontFamily:"'Funnel Display',sans-serif",fontSize:20,fontWeight:900,textTransform:'uppercase',letterSpacing:'.03em',color:'#fff',lineHeight:1}}>{lv.name}</span>
        </div>
        <div style={{fontFamily:"'Funnel Display',sans-serif",fontSize:30,fontWeight:900,lineHeight:.9,color:bump?'#ff2d78':'#aa44ff',transition:'color .3s ease',textShadow:bump?'0 0 14px rgba(255,45,120,.7)':'0 0 10px rgba(170,68,255,.5)'}}>
          ...
          <div>
            ...
            <div className="pd-card">
              <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:8}}>
                ...
                <div style={{flex:1}}>
                  <div style={{fontFamily:"'Funnel Display',sans-serif",fontSize:20,fontWeight:900,color:'#fff',textTransform:'uppercase',letterSpacing:'.04em',marginBottom:2}}>{fullProfile.display_name}</div>
