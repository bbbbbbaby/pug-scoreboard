...
const css = `
  ...
  .login-logo { width:min(320px,78vw); height:150px; margin:0 auto; background-size:contain; background-repeat:no-repeat; background-position:center; }
  .login-claim { font-size:clamp(22px,6vw,32px); color:#D41323; margin-top:14px; line-height:1.15; }
  ...
  return (
    <div className="login-wrap" style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px 16px",position:"relative"}}>
      ...
      <div style={{textAlign:"center",marginBottom:32}}>
        <div className="logo-w login-logo" style={{display:"block"}}/>
        ...
        {tab === "profilo" && fullProfile && (
          <div>
            ...
            <div className="pd-av-zone">
              ...
              {(() => {
                const nx = LEVELS.find(l => l.xp > fullProfile.xp);
                return (
                  <div className="hand pd-xp-missing">
                    {nx ? <>mancano {nx.xp - fullProfile.xp} xp a {nx.name}</> : <>livello massimo!</>}
                  </div>
                );
              })()}
            </div>
              ...
              <div style={{display:'flex',alignItems:'center',gap:10,marginBottom:8}}>
                ...
                <div style={{flex:1}}>
                  <div className="hand pd-first-hand" style={{fontSize:26,lineHeight:1.1,marginBottom:3,cursor:'pointer'}}
                    ...
                    {fullProfile.first_name || 'scrivi il tuo nome ✏️'}
                  </div>
