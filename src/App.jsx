            ...
            <div className="pug-hero" style={{paddingTop:6}}>
              ...
              <div className="pug-roomzone">
                <div className="pug-room">
                  ...
                  {visConfig.creatura !== false && burp && <div style={{position:"absolute",left:"41%",top:"44%",fontFamily:"var(--hand), 'Jelek Type', cursive",fontSize:30,fontWeight:700,color:"#101010",animation:"pugburp 2.5s ease-out forwards",zIndex:7,pointerEvents:"none",whiteSpace:"nowrap"}}>BURP!</div>}
