...
.edu-main.ebg-azzurro{background:#A3CFFF url(/public/sfondi/sfondo-azzurro-wide.webp) top center/cover no-repeat!important}
.edu-main.ebg-rosa{background:#FF6DEC url(/public/sfondi/sfondo-rosa-wide.webp) top center/cover no-repeat!important}
.edu-main.ebg-giallo{background:#FCEF25 url(/public/sfondi/sfondo-giallo-wide.webp) top center/cover no-repeat!important}
.edu-main.ebg-verde{background:#339967 url(/public/sfondi/sfondo-verde-wide.webp) top center/cover no-repeat!important}
...
.edu-main.ebg-verde{background-image:url(/public/sfondi/sfondo-verde-tel.webp)!important}
.edu-main.ebg-rosso{background-image:url(/public/sfondi/sfondo-rosso-tel.webp)!important}
body:not(.light) .edu-main{background-image:url(/public/sfondi/sfondo-notte-tel.webp)!important}
}
...
@keyframes pugfoodpop{0%{transform:translate(-50%,-150%) scale(.2);opacity:0}28%{transform:translate(-50%,-78%) scale(1.3);opacity:1}52%{transform:translate(-50%,-50%) scale(1);opacity:1}74%{transform:translate(-50%,-50%) scale(1);opacity:1}100%{transform:translate(-50%,-50%) scale(.35);opacity:0}}
@keyframes pugburp{0%{opacity:0;transform:translateY(8px) rotate(-8deg) scale(.5)}30%{opacity:1;transform:translateY(0) rotate(-8deg) scale(1.15)}80%{opacity:1;transform:translateY(-8px) rotate(-8deg) scale(1)}100%{opacity:0;transform:translateY(-18px) rotate(-8deg) scale(1)}}
...
.player-wrap.bg-azzurro{background:#A3CFFF url(/public/sfondi/sfondo-azzurro-tel.webp) top center/cover no-repeat}
.player-wrap.bg-rosa{background:#FF6DEC url(/public/sfondi/sfondo-rosa-tel.webp) top center/cover no-repeat}
.player-wrap.bg-giallo{background:#FCEF25 url(/public/sfondi/sfondo-giallo-tel.webp) top center/cover no-repeat}
.player-wrap.bg-verde{background:#339967 url(/public/sfondi/sfondo-verde-tel.webp) top center/cover no-repeat}
.player-wrap.bg-rosso{background:#D41423 url(/public/sfondi/sfondo-rosso-tel.webp) top center/cover no-repeat}
.player-wrap.bg-notte{background:#0d0d0d url(/public/sfondi/sfondo-notte-tel.webp) top center/cover no-repeat}
@media(min-width:640px){
.player-wrap.bg-azzurro{background-image:url(/public/sfondi/sfondo-azzurro-wide.webp)}
.player-wrap.bg-rosa{background-image:url(/public/sfondi/sfondo-rosa-wide.webp)}
.player-wrap.bg-giallo{background-image:url(/public/sfondi/sfondo-giallo-wide.webp)}
.player-wrap.bg-verde{background-image:url(/public/sfondi/sfondo-verde-wide.webp)}
.player-wrap.bg-rosso{background-image:url(/public/sfondi/sfondo-rosso-wide.webp)}
.player-wrap.bg-notte{background-image:url(/public/sfondi/sfondo-notte-wide.webp)}
}
...
function PlayerDashboard({ profile, onLogout, sectionColors }) {
  ...
  async function feedPet() {
    ...
    if (!error && r?.ok) {
      ...
      setPopKey(k => k + 1); setBurp(true); setTimeout(()=>setBurp(false), 1300);
            ...
            <div className="pug-hero" style={{paddingTop:6}}>
              ...
              <div className="pug-roomzone">
                <div className="pug-room">
                  ...
                  {visConfig.creatura !== false && popKey>0 && <img key={popKey} src={FOODS[selectedFood]?.img} alt="" style={{position:"absolute",left:"49%",top:"56%",width:48,height:48,objectFit:"contain",filter:"drop-shadow(0 5px 3px rgba(0,0,0,.35))",animation:"pugfoodpop 1s ease-out forwards",zIndex:4,pointerEvents:"none"}}/>}
                  {visConfig.creatura !== false && burp && <div style={{position:"absolute",left:"41%",top:"44%",fontFamily:"var(--hand), 'Jelek Type', cursive",fontSize:30,fontWeight:700,color:"#101010",animation:"pugburp 1.2s ease-out forwards",zIndex:7,pointerEvents:"none",whiteSpace:"nowrap"}}>BURP!</div>}
